...
class Booking {
	...
	$labels = array(
	    'name' => __('Events', $this->translation_domain),
	    'singular_name' => __('Event', $this->translation_domain),
	    'add_new' => __('Add Event', $this->translation_domain),
	    'add_new_item' => __('Add New Event', $this->translation_domain),
	    'edit_item' => __('Edit Event', $this->translation_domain),
	    'new_item' => __('New Event', $this->translation_domain),
	    'view_item' => __('View Event', $this->translation_domain),
	    'search_items' => __('Search Event', $this->translation_domain),
	    'not_found' =>  __('No event found', $this->translation_domain),
	    'not_found_in_trash' => __('No event found in Trash', $this->translation_domain),
	    'menu_name' => __('Events', $this->translation_domain)
	);
	...
	add_meta_box('incsub-event-where', __('Where', $this->translation_domain), array(&$this, 'where_meta_box'), 'incsub_event', 'side');
	add_meta_box('incsub-event-when', __('When', $this->translation_domain), array(&$this, 'when_meta_box'), 'incsub_event', 'side');
	add_meta_box('incsub-event-status', __('Status', $this->translation_domain), array(&$this, 'status_meta_box'), 'incsub_event', 'side');
	// add_meta_box('incsub-event-chain', __('Next Event', $this->translation_domain), array(&$this, 'chain_meta_box'), 'incsub_event', 'side');
	add_meta_box('incsub-event-bookings', __('Bookings', $this->translation_domain), array(&$this, 'bookings_meta_box'), 'incsub_event', 'normal');
    }
	...
	$content .= __('Venue', $this->translation_domain).':&nbsp;';
	...
	$content .= '<div class="misc-pub-section">';
	$content .= __('Start', $this->translation_domain).':&nbsp;';
	...
	$content .= '<div class="misc-pub-section">';
	$content .= __('End', $this->translation_domain).':&nbsp;&nbsp;&nbsp;';
	...
	$content .= '<div class="misc-pub-section">';
	$content .= __('Status', $this->translation_domain).':&nbsp;';
	...
	$content .= __('No bookings', $this->translation_domain);
	$content .= '</div>';
	$content .= '<div class="clear"></div>';
	...
	$columns['venue'] = __('Venue', 'eab');
	$columns['start'] = __('Date', 'eab');

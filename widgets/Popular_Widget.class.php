...
class Eab_Popular_Widget extends Eab_Widget {
	...
	$instance = $old_instance;
        $new_instance = wp_parse_args( (array) $new_instance, array( 'title' => __('Most Popular', $this->translation_domain), 'hierarchical' => 'yes') );
	...
	$instance = wp_parse_args( (array) $instance, array( 'title' => __('Most Popular', $this->translation_domain)));
	...
	<div style="text-align:left">
	    ...
	    <input type="hidden" name="eab-submit" id="eab-submit" value="popular" />
	</div>
	<?php
    }
}

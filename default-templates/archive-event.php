        ...
        <div id="eab-page-wrapper">
            ...
            ?>
                ...
                <div id="eab-calendar-month">
                    ...
                    <div class="eab-header eab-header-<?php echo $c; ?>"><?php echo date_i18n('l', 1319328000+($c*3600*24)); ?></div>
                    <?php } ?>
                    <div class="clear"></div>
                ...
                <style type="text/css">
                    div.eab-premonth {
                        width: <?php echo 13*(date('w', strtotime($wp_query->query_vars['year'].'-'.$wp_query->query_vars['monthnum'].'-01'))-$week_start); ?>%;
                        padding: 0 <?php echo 3*(date('w', strtotime($wp_query->query_vars['year'].'-'.$wp_query->query_vars['monthnum'].'-01'))-$week_start); ?>px;
                        margin: 0 <?php echo 3*(date('w', strtotime($wp_query->query_vars['year'].'-'.$wp_query->query_vars['monthnum'].'-01'))-$week_start); ?>px;
                    }
                </style>
                <?php else: ?>
                <p><?php $event_ptype = get_post_type_object( 'incsub_event' ); echo $event_ptype->labels->not_found; ?></p>
